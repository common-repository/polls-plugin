...
class Polls{
	...
	public function __construct(){
		...
		wp_enqueue_script('jPolls', plugins_url('/js/Polls.js', SP_FILE));
		if (!in_array('jPolls', $wp_scripts->done) && !in_array('jPolls', $wp_scripts->in_footer)) {
			$wp_scripts->in_footer[] = 'jPolls';
		}
	}
